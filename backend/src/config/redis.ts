...
export class RedisConfig {
  private static logger = new Logger('RedisConfig');
  ...
  public static async setCached<T>(key: string, data: T, ttlSeconds?: number): Promise<boolean> {
    try {
      const client = this.getClient();
  ...
  public static async deleteCached(key: string): Promise<boolean> {
    try {
      const client = this.getClient();
  ...
  public static async clearCache(pattern: string = '*'): Promise<boolean> {
    try {
      const client = this.getClient();
