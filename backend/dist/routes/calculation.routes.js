...
const logger = new logger_1.Logger('CalculationRoutes');
 ...
 */
router.post('/option-price', auth_middleware_1.authMiddleware, rateLimiter_1.rateLimitMiddleware, async (req, res) => {
    try {
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.post('/greeks', auth_middleware_1.authMiddleware, rateLimiter_1.rateLimitMiddleware, async (req, res) => {
    try {
        const params = req.body;
        // Validate required parameters
        const required = ['underlyingPrice', 'strikePrice', 'timeToExpiration', 'riskFreeRate', 'volatility', 'optionType'];
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.post('/position-metrics', auth_middleware_1.authMiddleware, rateLimiter_1.rateLimitMiddleware, async (req, res) => {
    try {
        ...
        const required = ['underlyingPrice', 'strikePrice', 'timeToExpiration', 'riskFreeRate', 'volatility', 'optionType'];
        for (const field of required) {
            if (optionParams[field] === undefined) {
                return void res.status(400).json({
                    error: 'Bad Request',
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.post('/portfolio-risk', auth_middleware_1.authMiddleware, rateLimiter_1.rateLimitMiddleware, async (req, res) => {
    try {
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.post('/five-factor-score', auth_middleware_1.authMiddleware, rateLimiter_1.rateLimitMiddleware, async (req, res) => {
    try {
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.post('/implied-volatility', auth_middleware_1.authMiddleware, rateLimiter_1.rateLimitMiddleware, async (req, res) => {
    try {
        const { marketPrice, underlyingPrice, strikePrice, timeToExpiration, riskFreeRate, optionType } = req.body;
        const required = { marketPrice, underlyingPrice, strikePrice, timeToExpiration, riskFreeRate, optionType };
        ...
        const impliedVolatility = calculationService.calculateImpliedVolatility(marketPrice, {
